...
function initmap() {
	...
	jQuery(".googleMap").each(function () {
		...
		if (validatedata(location)) {
			...
			$this.gmap3({
				//key: 'AIzaSyCnDbD9BqSstEmrzFtQeLu8gbmC2EfM8UE',
				marker: {
...
function loadScript() {
	...
	script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCnDbD9BqSstEmrzFtQeLu8gbmC2EfM8UE&v=3.exp&' + 'callback=initmap';
...
jQuery(document).ready(function () {
	...
	$(".content-area, .parallaxSection").each(function () {
		...
		if (validatedata(bgPos, 'center center')) {
